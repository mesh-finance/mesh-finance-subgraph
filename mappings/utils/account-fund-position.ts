...
import * as fundPositionUpdateLibrary from './account-fund-position-update';
...
export function getBalancePosition(
  ...
  let decimals = utilLibrary.getDecimals(fundContract);
...
export function deposit(
  ...
  let token = Token.load(fund.underlyingToken) as Token;
  let balanceShares = fundContract.balanceOf(Address.fromString(account.id));
